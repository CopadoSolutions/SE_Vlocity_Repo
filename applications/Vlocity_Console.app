...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        <componentList>
            ...
            <components>VlocityChat</components>
        </componentList>
        <detailPageRefreshMethod>autoRefresh</detailPageRefreshMethod>
        <footerColor>#FF6E0D</footerColor>
        <headerColor>#F8FBFE</headerColor>
        <keyboardShortcuts>
            <defaultShortcuts>
        ...
        <primaryTabColor>#FF6E0D</primaryTabColor>
    </consoleConfig>
