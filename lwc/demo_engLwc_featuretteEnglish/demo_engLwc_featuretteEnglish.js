...
import { OMNIDEF } from './demo_engLwc_featuretteEnglish_def.js';
import tmpl from './demo_engLwc_featuretteEnglish.html';
import tmpl_nds from './demo_engLwc_featuretteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demo_engLwc_featuretteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
