...
import { OMNIDEF } from './demo_engFeaturette_LWCEnglish_def.js';
import tmpl from './demo_engFeaturette_LWCEnglish.html';
import tmpl_nds from './demo_engFeaturette_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demo_engFeaturette_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
