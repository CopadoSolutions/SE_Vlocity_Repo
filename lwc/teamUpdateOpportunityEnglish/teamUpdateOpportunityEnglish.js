...
import { OMNIDEF } from './teamUpdateOpportunityEnglish_def.js';
import tmpl from './teamUpdateOpportunityEnglish.html';
import tmpl_nds from './teamUpdateOpportunityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamUpdateOpportunityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
