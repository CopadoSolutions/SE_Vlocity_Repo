...
import { OMNIDEF } from './demo_engLwccheckoutEnglish_def.js';
import tmpl from './demo_engLwccheckoutEnglish.html';
import tmpl_nds from './demo_engLwccheckoutEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demo_engLwccheckoutEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
