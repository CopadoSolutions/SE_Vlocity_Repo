...
baseCtrl.prototype.addOfferToBasketV2 = function(offer, control, scp, autoAdvance) {
    ...
    console.log("JLH >> offerCode 01:  " + offer.addtocart.rest.params.offer);
    console.log("JLH >> offerCode 02:  " + scp.bpTree.response.offerCode);

    console.log("JLH >> basketAction 01:  " + offer.addtocart.rest.params.basketAction);
    console.log("JLH >> basketAction 02:  " + scp.bpTree.response.basketAction);
